 ...
 * @method static Route route(string $pattern, callable $callback, bool|array $route_config = false, string $alias = '')
 * @method static void group(string $pattern, callable $callback, array $group_middlewares = [])
 * @method static Route post(string $pattern, callable $callback, bool|array $route_config = false, string $alias = '')
 * @method static Route put(string $pattern, callable $callback, bool|array $route_config = false, string $alias = '')
 * @method static Route patch(string $pattern, callable $callback, bool|array $route_config = false, string $alias = '')
 * @method static Route delete(string $pattern, callable $callback, bool|array $route_config = false, string $alias = '')
 ...
 * @phpstan-method static Route route(string $pattern, callable|string|array{0: class-string, 1: string} $callback, bool|array<string, mixed> $route_config = false, string $alias = '')
 ...
 * @phpstan-method static Route post(string $pattern, callable|string|array{0: class-string, 1: string} $callback, bool|array<string, mixed> $route_config = false, string $alias = '')
 * @phpstan-method static Route put(string $pattern, callable|string|array{0: class-string, 1: string} $callback, bool|array<string, mixed> $route_config = false, string $alias = '')
 * @phpstan-method static Route patch(string $pattern, callable|string|array{0: class-string, 1: string} $callback, bool|array<string, mixed> $route_config = false, string $alias = '')
 * @phpstan-method static Route delete(string $pattern, callable|string|array{0: class-string, 1: string} $callback, bool|array<string, mixed> $route_config = false, string $alias = '')
