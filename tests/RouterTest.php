...
class RouterTest extends \PHPUnit\Framework\TestCase {
    ...
    function testRegexOptionalParameters() {
        $this->router->map( '/@controller/@method(/@id:[0-9]+)',
    ...
    function testRegExParametersCyrillic() {
        $this->router->map( '/категория/@name:[абвгдеёжзийклмнопрстуфхцчшщъыьэюя]+',
                            function ( $name ) {
            echo $name;
        } );
